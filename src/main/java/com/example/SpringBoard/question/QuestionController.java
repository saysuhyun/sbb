...
@RequiredArgsConstructor // final 붙은 속성 포함 생성자를 자동 생성
@Controller
@RequestMapping("/question")
public class QuestionController {

    // autowired 안 쓰고도 @RequiredArgsConstructor 쓰면 됨
    ...
    @PreAuthorize("isAuthenticated()") // 로그인 된 유저만 사용 가능해짐 로그아웃상태면 로그인 페이지로 이동시킴
    @GetMapping("/create")
